...
struct tp_work_s{
    ...
    void (*process_job) (tp_work *thisPool, tp_work_desc *job);
};
...
struct tp_thread_pool_s{
    TPBOOL (*init) (tp_thread_pool *thisPool);
    void (*close) (tp_thread_pool *thisPool);
    void (*process_job) (tp_thread_pool *thisPool, tp_work *worker, tp_work_desc *job);
    int  (*get_thread_by_id) (tp_thread_pool *thisPool, int id);
    TPBOOL (*add_thread) (tp_thread_pool *thisPool);
    TPBOOL (*delete_thread) (tp_thread_pool *thisPool);
    int (*get_tp_status) (tp_thread_pool *thisPool);
